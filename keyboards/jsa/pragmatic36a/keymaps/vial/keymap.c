...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
     [0] = LAYOUT(
        ...
        _______, LT(3,KC_CAPS), LT(1,KC_BSPC),         LT(2,KC_SPC), LT(4,KC_ENT), _______
    ),
    [1] = LAYOUT(
        ...
        _______, WKSPLF,  MSNCTL,  WKSPRT,  KC_SPC,  KC_DLR,  KC_P1,   KC_P2,   KC_P3,   KC_PSLS,
                           _______, _______, XXXXXXX, KC_P0,   KC_PDOT, _______
    ),
    [2] = LAYOUT(
        ...
        KC_BSLS, KC_AMPR, KC_PIPE, KC_LBRC, KC_RBRC, KC_CAPS, KC_PGDN, _______, _______, _______,
                           _______,_______, KC_DEL,  XXXXXXX, _______, _______
    ),
    [3] = LAYOUT(
    ...
    [4] = LAYOUT(
       QK_RBT,  _______, _______, _______, _______, _______, KC_BRIU, KC_VOLU, ZOOMIN,  _______,
